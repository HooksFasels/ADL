...
export const api = {
  ...
  login: (data: any) =>
    client.post<ApiResponse<any>>('/api/v1/auth/login', data).then((r) => r.data),
  ...
  getAssignmentByDriverId: (driverId: string) =>
    client
      .get<ApiResponse<any>>(`/api/v1/assignments/active?driverId=${driverId}`)
      .then((r) => r.data),
  updateLocation: (data: {
    vehicleId: string;
    latitude: number;
  ...
  deleteDriver: (id: string) =>
    client.delete<ApiResponse<any>>(`/api/v1/admin/drivers/${id}`).then((r) => r.data),

  createAdminRoute: (data: any) =>
    client.post<ApiResponse<any>>('/api/v1/admin/routes', data).then((r) => r.data),
  deleteAdminRoute: (id: string) =>
    client.delete<ApiResponse<any>>(`/api/v1/admin/routes/${id}`).then((r) => r.data),
  createAdminStop: (data: any) =>
    client.post<ApiResponse<any>>('/api/v1/admin/stops', data).then((r) => r.data),
  deleteAdminStop: (id: string) =>
    client.delete<ApiResponse<any>>(`/api/v1/admin/stops/${id}`).then((r) => r.data),
  ...
  deleteVehicle: (id: string) =>
    client.delete<ApiResponse<any>>(`/api/v1/buses/buses/${id}`).then((r) => r.data),

  // ── Transit Admin – Assignments ─────────────────────────────────────────────
  getAssignments: () =>
    client.get<ApiResponse<any[]>>('/api/v1/admin/assignments').then((r) => r.data),
  ...
  deleteAssignment: (id: string) =>
    client.delete<ApiResponse<any>>(`/api/v1/admin/assignments/${id}`).then((r) => r.data),

  startTrip: (data: { vehicleId: string; routeId: string }) =>
    client.post<ApiResponse<any>>('/api/v1/trips/start', data).then((r) => r.data),
  endTrip: (id: string) =>
    client.patch<ApiResponse<any>>(`/api/v1/trips/${id}/end`, {}).then((r) => r.data),
};
